...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        # Send 26250 CBTC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 62500 cbtc in block rewards plus fees, but
        ...
        # Send 12500 CBTC with subtract fee from amount
        ...
        # Sendmany 12500 CBTC with subtract fee from amount
