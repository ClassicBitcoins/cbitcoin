...
#if defined(NDEBUG)
# error "CBTC cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "CBTC Signed Message:\n";
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // In CBTC this has been enforced since launch, except that the genesis
    // block didn't include the height in the coinbase (see CBTC protocol spec
