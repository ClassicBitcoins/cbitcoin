// Copyright (c) 2018-2019 The CBTC Community
...
./cbtcd -printtoconsole -sendalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "Your client is out of date and incompatible with the Sapling network upgrade. Please update to a recent version of CBTC (2.0.1 or later).";
