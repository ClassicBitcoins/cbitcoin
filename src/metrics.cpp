...
int printMiningStatus(bool mining)
{
    ...
    if (mining) {
        ...
        std::cout << _("To enable mining, add 'gen=1' to your cbtc.conf and restart.") << std::endl;
        lines += 2;
    }
    std::cout << std::endl;
        ...
        CAmount mature {0};
        {
            ...
            while (it != u->end()) {
                ...
                if (mapBlockIndex.count(hash) > 0 &&
                    ...
                    if (height >= 295000 && height <= 500000) {
...
void ThreadShowMetricsScreen()
{
    ...
    if (isScreen) {
        ...
        // Thank you text
        std::cout << _("Thank you for running a CBTC node!") << std::endl;
