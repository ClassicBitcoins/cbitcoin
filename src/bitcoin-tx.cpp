...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("CBTC cbtc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cbtc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cbtc transaction") + "\n" +
              "  cbtc-tx [options] -create [commands]   " + _("Create hex-encoded cbtc transaction") + "\n" +
              "\n";
