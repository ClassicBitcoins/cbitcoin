...
For instance:
    ...
    $ cbtcd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/cbtcd.tx.raw
...
From the perspective of cbtcd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into cbtcd directly. Furthermore, no information is
...
using. CBTCd appends an up-counting sequence number to each
